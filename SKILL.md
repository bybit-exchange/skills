...
metadata:
  version: 1.6.1  # Modular Architecture + Security Baseline
  author: Bybit
  updated: 2026-09-02
license: MIT
---
...
2. If the module has NOT been loaded in this session:
   ...
   b. Download: curl -sf -H "User-Agent: bybit-skill/1.6.1" https://raw.githubusercontent.com/bybit-exchange/skills/main/modules/<module>.md
...
curl -s "${BASE_URL}/v5/position/list?${QUERY}" \
  ...
  -H "User-Agent: bybit-skill/1.6.1" \
